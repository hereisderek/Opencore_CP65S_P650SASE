 ...
 *
 * Disassembly of SSDT6.aml, Fri Dec  6 23:33:10 2019
 *
...
DefinitionBlock ("", "SSDT", 1, "HASEE ", "PARADISE", 0x00003000)
{
    ...
    OperationRegion (SANV, SystemMemory, 0xBD792E18, 0x016D)
        ...
        Device (GFX0)
        {
            ...
            Device (LCD0)
            {
                ...
                Method (_BCM, 1, NotSerialized)  // _BCM: Brightness Control Method
                {
                    ...
                    {
                        If ((\_SB.PCI0.LPCB.EC.WINF & One))
                        {
                            \_SB.PCI0.LPCB.EC.OEM2 = Local2
                        }
                ...
                Method (_BQC, 0, NotSerialized)  // _BQC: Brightness Query Current
                {
                    If (\_SB.WMI.HKDR)
                    {
                        If (\_SB.PCI0.LPCB.EC.ECOK)
                        {
                            Local0 = \_SB.PCI0.LPCB.EC.OEM2 /* External reference */
                            If ((OSYS < 0x07DC))
                            {
                                If ((Local0 == 0x07))
                                {
