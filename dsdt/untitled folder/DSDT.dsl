 ...
 *
 * Disassembly of DSDT.aml, Wed Jun 19 23:04:15 2019
 *
...
DefinitionBlock ("", "DSDT", 2, "HASEE ", "PARADISE", 0x00000038)
{
                ...
                Device (PR01)
                {
                    ...
                    Device (PR18)
                    {
                        ...
                        Method (_PLD, 0, Serialized)  // _PLD: Physical Location of Device
                        {
                            ...
                            Store (Zero, VIS) /* \_SB_.PCI0.EHC1.HUBN.PR01.PR18._PLD.VIS_ */
                ...
                Device (PR01)
                {
                    ...
                    Device (PR14)
                    {
                        ...
                        Method (_PLD, 0, Serialized)  // _PLD: Physical Location of Device
                        {
                            ...
                            {
                                Store (Zero, VIS) /* \_SB_.PCI0.EHC2.HUBN.PR01.PR14._PLD.VIS_ */
                            }
                            Else
                            {
                                Store (Zero, VIS) /* \_SB_.PCI0.EHC2.HUBN.PR01.PR14._PLD.VIS_ */
            ...
            If (^EC.ECOK)
            {
                If (LEqual (Arg0, 0x03))
                {
                    If (CondRefOf (\_SB.IFFS.FFSS))
                    {
                        ...
                        Store (^EC.ECKS, ^EC.XXE2) /* \_SB_.PCI0.LPCB.EC__.XXE2 */
    ...
    Method (_WAK, 1, Serialized)  // _WAK: Wake
    {
        ...
        If (LOr (LEqual (Arg0, 0x03), LEqual (Arg0, 0x04)))
        {
            ...
            Store (One, \_SB.PCI0.GFX0.CLID) /* External reference */
        ...
        Store (Zero, \_SB.PCI0.PEG0.PEGP.NHDM) /* External reference */
        Return (Package (0x02)
        {
            Zero, 
            Zero
            ...
            Method (WMBB, 3, Serialized)
            {
                ...
                If (LEqual (ToInteger (Arg1), 0x13))
                {
                    If (^^PCI0.LPCB.EC.ECOK)
                    {
                        If (ARGS)
                        {
                            Or (^^PCI0.LPCB.EC.ECKS, 0x80, ^^PCI0.LPCB.EC.ECKS) /* \_SB_.PCI0.LPCB.EC__.ECKS */
                        }
                        Else
                        {
                            And (^^PCI0.LPCB.EC.ECKS, 0x7F, ^^PCI0.LPCB.EC.ECKS) /* \_SB_.PCI0.LPCB.EC__.ECKS */
                        }
                    }
                        ...
                        Else
                        {
                            ...
                            If (LEqual (Local7, 0x0E))
                            {
                                ...
                                If (And (LKFG, 0x04))
                                {
                                    Store (Local0, ODA0) /* \ODA0 */
                                    Store (ShiftRight (Local0, 0x08), ODA1) /* \ODA1 */
                                    Store (ShiftRight (Local0, 0x10), ODA2) /* \ODA2 */
                                ...
                                Else
                                {
                                    Store (Local0, ^^PCI0.LPCB.EC.FDAT) /* \_SB_.PCI0.LPCB.EC__.FDAT */
                                    Store (ShiftRight (Local0, 0x08), ^^PCI0.LPCB.EC.FBUF) /* \_SB_.PCI0.LPCB.EC__.FBUF */
                                    Store (ShiftRight (Local0, 0x10), ^^PCI0.LPCB.EC.FBF1) /* \_SB_.PCI0.LPCB.EC__.FBF1 */
                                    Store (0xC7, ^^PCI0.LPCB.EC.FCMD) /* \_SB_.PCI0.LPCB.EC__.FCMD */
                                }
                            }
        ...
        Device (EC)
        {
            ...
            Method (_REG, 2, NotSerialized)  // _REG: Region Availability
            {
                If (LAnd (LEqual (Arg0, 0x03), LEqual (Arg1, One)))
                {
                    ...
                    Store (One, PSLC) /* \_SB_.PCI0.LPCB.EC__.PSLC */
                    Store (Zero, CCST) /* \_SB_.PCI0.LPCB.EC__.CCST */
                    Store (Zero, PRC0) /* \_SB_.PCI0.LPCB.EC__.PRC0 */
                    Store (Zero, PRC1) /* \_SB_.PCI0.LPCB.EC__.PRC1 */
                    Store (Zero, PRIN) /* \_SB_.PCI0.LPCB.EC__.PRIN */
                    Store (Zero, PSTE) /* \_SB_.PCI0.LPCB.EC__.PSTE */
                    PNOT ()
                }
            }
            ...
            Method (_Q16, 0, Serialized)  // _Qxx: EC Query, xx=0x00-0xFF
            {
                ...
                Store (Zero, TBFG) /* \_SB_.PCI0.LPCB.EC__.TBFG */
                Store (Zero, ECTB) /* \_SB_.PCI0.LPCB.EC__.ECTB */
                ^^^^AC.ADJP (Zero)
            }
            ...
            Method (_Q42, 0, NotSerialized)  // _Qxx: EC Query, xx=0x00-0xFF
            {
                ...
                Store (Increment (PRC0), PRC0) /* \_SB_.PCI0.LPCB.EC__.PRC0 */
                Store (One, TBFG) /* \_SB_.PCI0.LPCB.EC__.TBFG */
            ...
            Method (_Q53, 0, NotSerialized)  // _Qxx: EC Query, xx=0x00-0xFF
            {
                ...
                Store (Increment (PRC1), PRC1) /* \_SB_.PCI0.LPCB.EC__.PRC1 */
                Store (Zero, TBFG) /* \_SB_.PCI0.LPCB.EC__.TBFG */
                Store (Zero, ECTB) /* \_SB_.PCI0.LPCB.EC__.ECTB */
                ^^^^AC.ADJP (Zero)
            }
            ...
            Method (_Q54, 0, NotSerialized)  // _Qxx: EC Query, xx=0x00-0xFF
            {
                ...
                Store (0x08, CCST) /* \_SB_.PCI0.LPCB.EC__.CCST */
                Store (Increment (PRIN), PRIN) /* \_SB_.PCI0.LPCB.EC__.PRIN */
                Store (Zero, PSLC) /* \_SB_.PCI0.LPCB.EC__.PSLC */
                ^^^^AC.ADJP (Zero)
                Store (Zero, TBFG) /* \_SB_.PCI0.LPCB.EC__.TBFG */
                Store (Zero, ECTB) /* \_SB_.PCI0.LPCB.EC__.ECTB */
            }
            ...
            {
                Store (0x55, P80H) /* \P80H */
                Store (Zero, CCST) /* \_SB_.PCI0.LPCB.EC__.CCST */
                Store (Increment (PSTE), PSTE) /* \_SB_.PCI0.LPCB.EC__.PSTE */
                Store (One, PSLC) /* \_SB_.PCI0.LPCB.EC__.PSLC */
                ^^^^AC.ADJP (Zero)
                Store (Zero, TBFG) /* \_SB_.PCI0.LPCB.EC__.TBFG */
                Store (Zero, ECTB) /* \_SB_.PCI0.LPCB.EC__.ECTB */
